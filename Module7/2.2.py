...
employees={"PY001":["James", "Developer"],
           "PY102":["Alex","Team Lead"],
           "PY440":["Keith","Designer"],
           "PY324":["Susan","Project Manager"],
           "PY100":["Michael","Tester"]}
...
employees.update({"PY440":["Keith","Solution Designer"]})
print(employees)
